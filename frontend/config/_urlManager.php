...
return [
    ...
    'rules' => [
        ...
        ['class' => \frontend\config\rules\LocaleUrlRule::class],
        ['class' => \frontend\config\rules\TokenResultUrlRule::class],

        ['pattern' => '<locale>/site/<action>', 'route' => 'site/<action>'],
        ['pattern' => '<locale>/user/<controller>/<action>', 'route' => 'user/<controller>/<action>'],
